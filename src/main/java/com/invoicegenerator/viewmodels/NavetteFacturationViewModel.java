...
public class NavetteFacturationViewModel {
    ...
    private String formatDate(LocalDate date, DateTimeFormatter formatter) {
        if (date != null) {
            ...
            logger.log(Level.FINE, "Date formatée : {0} avec le formatteur {1}", new Object[]{formattedDate, formatter});
    ...
    private String extraireMois(LocalDate date) {
        ...
        logger.log(Level.FINE, "Récupération du mois : {0} sur la date {1}", new Object[]{mois, date});
        return mois;
    }
